...
const courseFlow = addKeyword<Provider, Database>([""])
    .addAnswer(courseDescriptions[courseNumber])

const welcomeFlow = addKeyword<Provider, Database>(['hi', 'hello', 'hola'])
    .addAnswer('🙌 ¡¡Bienvenido a *IITA* - Instituto de Innovación y Tecnología Aplicada!!')
    .addAnswer('Actualmente estamos inscribiendo para los siguientes cursos:\n\n*1.* Taller anual de robótica con Lego\n*2.* Taller de programacion con python con inteligencia artificial\n*3.* Curso de robotica con arduino con inteligencia artificial\n*4.* Curso de marketing digital con inteligencia artificial.')
...
// Inicio del servidor
    ...
    const main = async () => {
        const adapterFlow = createFlow([welcomeFlow, courseFlow])
